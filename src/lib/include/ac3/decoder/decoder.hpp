...
// coupling. Deliberately unsupported (clean errors, not wrong audio): block
// switching, delta bit allocation, dual mono. dynrng words are parsed but not
// applied; bap-0 bins reconstruct as zero regardless of dithflag (the spec
