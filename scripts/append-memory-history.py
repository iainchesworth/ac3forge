...
append-performance-history.py uses: a soft one (::warning::, never fails
...
this script keeps the series. Mirrors append-performance-history.py by
...
every other append script here (see append-performance-history.py).
"""
...
def load_leg_results(results_dir: Path):
    ...
    append-performance-history.py's, over ac3membench's schema."""
