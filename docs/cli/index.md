...
`ac3cli` is the command-line front end over `ac3::forge` — twenty-three commands covering
...
`--version` is a flag, not one of the twenty-three commands — it's handled before argument parsing
...
- [Commands](commands.md) — all 23 commands, grouped and with real usage text.
