...
`ac3cli` is the command-line front end over `ac3::forge` — twenty-four commands covering
...
`--version` is a flag, not one of the twenty-four commands — it's handled before argument parsing
...
- [Commands](commands.md) — all 24 commands, grouped and with real usage text.
