...
a coverage gate over the library, a per-platform gold-reference quality gate, and a dedicated
Linux FFmpeg-validation leg. See [docs/building.md](docs/building.md#verified-configuration) for
...
capture and playback, and peak/RMS/loudness metering.
