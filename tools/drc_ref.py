...
Run from the repo root:
    python tools/drc_ref.py            # self-check, print a summary
    python tools/drc_ref.py --emit     # write tests/golden/drc_goldens.hpp
"""
...
def emit() -> None:
    cases = sweep()
    lines = [
        "// GENERATED by tools/drc_ref.py - do not edit by hand. An independent",
